...
- Execução: 2026-07-09T05:53:29+00:00
...
- Unpaywall: ativado; registros enriquecidos: 37
...
- **Crossref** — recuperados: 300
  ...
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 20
    ...
    - URL: `https://api.crossref.org/works?query.bibliographic=work+disability+AND+medical+certification&rows=20&select=DOI%2Ctitle%2Cauthor%2Cpublished-print%2Cpublished-online%2Cissued%2Ccontainer-title%2Cabstract%2Ctype%2CURL&mailto=REDACTED`
  ...
  - Teleperícia e avaliação remota — recuperados: 20
    ...
    - URL: `https://api.crossref.org/works?query.bibliographic=telemedicine+AND+disability+assessment&rows=20&select=DOI%2Ctitle%2Cauthor%2Cpublished-print%2Cpublished-online%2Cissued%2Ccontainer-title%2Cabstract%2Ctype%2CURL&mailto=REDACTED`
  - Teleperícia e avaliação remota — recuperados: 20
...
- **Semantic Scholar** — recuperados: 200
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 20
    - expressão: `disability benefits AND medical assessment`
    - URL: `https://api.semanticscholar.org/graph/v1/paper/search?query=disability+benefits+AND+medical+assessment&limit=20&fields=title%2Cabstract%2Cauthors%2Cyear%2Cvenue%2CexternalIds%2Curl%2CopenAccessPdf%2CcitationCount%2CpublicationTypes`
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 0
    - expressão: `incapacity benefit AND medical evaluation`
    - aviso/erro: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 20
    - expressão: `work disability AND medical certification`
  ...
  - Equidade territorial, qualidade e controle — recuperados: 0
    - expressão: `medical certification AND audit`
    - aviso/erro: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}
  - resumo de falhas: Benefícios por incapacidade e avaliação médico-pericial: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}; Análise documental e elegibilidade: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}; Teleperícia e avaliação remota: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}; Capacidade, filas e alocação de serviços: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}; Equidade territorial, qualidade e controle: HTTP 429: {"message": "Too Many Requests. Please wait and try again or apply for a key for higher rate limits. https://www.semanticscholar.org/product/api#api-key-form", "code": "429"}
...
- **Web of Science** — recuperados: 0
  - situação: não executada: credencial ausente — Credencial obrigatória ausente: WOS_API_KEY.
...
- **SciELO** — recuperados: 0
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 0
    - expressão: `disability benefits AND medical assessment`
    - aviso/erro: SciELO bloqueou a automação com Bunny Shield; a fonte foi interrompida após a primeira tentativa.
  - situação: bloqueada por anti-automação — SciELO bloqueou a automação com Bunny Shield; a fonte foi interrompida após a primeira tentativa.
  - resumo de falhas: Benefícios por incapacidade e avaliação médico-pericial: SciELO bloqueou a automação com Bunny Shield; a fonte foi interrompida após a primeira tentativa.
- **CORE** — recuperados: 255
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 20
    - expressão: `disability benefits AND medical assessment`
    - URL: `https://api.core.ac.uk/v3/search/works?q=disability+benefits+AND+medical+assessment&limit=20`
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 20
    - expressão: `incapacity benefit AND medical evaluation`
    - URL: `https://api.core.ac.uk/v3/search/works?q=incapacity+benefit+AND+medical+evaluation&limit=20`
  - Benefícios por incapacidade e avaliação médico-pericial — recuperados: 20
    - expressão: `work disability AND medical certification`
    - URL: `https://api.core.ac.uk/v3/search/works?q=work+disability+AND+medical+certification&limit=20`
  - Análise documental e elegibilidade — recuperados: 20
    - expressão: `documentary assessment AND disability`
    - URL: `https://api.core.ac.uk/v3/search/works?q=documentary+assessment+AND+disability&limit=20`
  - Análise documental e elegibilidade — recuperados: 20
    - expressão: `medical certificate AND disability benefits`
    - URL: `https://api.core.ac.uk/v3/search/works?q=medical+certificate+AND+disability+benefits&limit=20`
  - Análise documental e elegibilidade — recuperados: 0
    - expressão: `medical documentation AND work incapacity`
    - aviso/erro: CORE não respondeu após recuperação com limite reduzido (10 resultados): HTTP 429: 
  - Teleperícia e avaliação remota — recuperados: 20
    - expressão: `remote medical assessment AND disability`
    - URL: `https://api.core.ac.uk/v3/search/works?q=remote+medical+assessment+AND+disability&limit=20`
  - Teleperícia e avaliação remota — recuperados: 20
    - expressão: `telemedicine AND disability assessment`
    - URL: `https://api.core.ac.uk/v3/search/works?q=telemedicine+AND+disability+assessment&limit=20`
  - Teleperícia e avaliação remota — recuperados: 15
    - expressão: `telehealth AND medical certification`
    - URL: `https://api.core.ac.uk/v3/search/works?q=telehealth+AND+medical+certification&limit=20`
  - Capacidade, filas e alocação de serviços — recuperados: 20
    - expressão: `disability benefits AND waiting time`
    - URL: `https://api.core.ac.uk/v3/search/works?q=disability+benefits+AND+waiting+time&limit=20`
  - Capacidade, filas e alocação de serviços — recuperados: 0
    - expressão: `medical assessment AND service capacity`
    - aviso/erro: CORE não respondeu após recuperação com limite reduzido (10 resultados): HTTP 429: 
  - Capacidade, filas e alocação de serviços — recuperados: 20
    - expressão: `case allocation AND disability services`
    - URL: `https://api.core.ac.uk/v3/search/works?q=case+allocation+AND+disability+services&limit=20`
  - Equidade territorial, qualidade e controle — recuperados: 20
    - expressão: `disability assessment AND equity of access`
    - URL: `https://api.core.ac.uk/v3/search/works?q=disability+assessment+AND+equity+of+access&limit=20`
  - Equidade territorial, qualidade e controle — recuperados: 20
    - expressão: `remote assessment AND quality assurance`
    - URL: `https://api.core.ac.uk/v3/search/works?q=remote+assessment+AND+quality+assurance&limit=20`
  - Equidade territorial, qualidade e controle — recuperados: 20
    - expressão: `medical certification AND audit`
    - URL: `https://api.core.ac.uk/v3/search/works?q=medical+certification+AND+audit&limit=20`
  - resumo de falhas: Análise documental e elegibilidade: CORE não respondeu após recuperação com limite reduzido (10 resultados): HTTP 429: ; Capacidade, filas e alocação de serviços: CORE não respondeu após recuperação com limite reduzido (10 resultados): HTTP 429: 

## Pré-triagem assistida por IA
- Modelo: gpt-5.4.
- Registros avaliados: 800 de 1437.
