...
printf 'pipenv run python -m academic_pipeline --config app_bundle/config/examples/paper_exemplo.toml --check-config\n'
printf 'pipenv run python -m academic_pipeline --config app_bundle/config/examples/paper_exemplo.toml --check-institution-compliance\n'
printf 'pipenv run python -m academic_pipeline --config app_bundle/config/examples/paper_exemplo.toml\n'
