...
def section_documentos_locais(values: dict[str, Any] | None = None) -> str:
    ...
    gerar_bib_revisado_ia = {toml_bool(v.get('gerar_bib_revisado_ia', False))}
    ...
    enriquecer_metadados_buscadores = {toml_bool(v.get('enriquecer_metadados_buscadores', False))}
    fontes_metadados = {toml_array(v.get('fontes_metadados', ['crossref', 'openalex', 'semantic_scholar']))}
