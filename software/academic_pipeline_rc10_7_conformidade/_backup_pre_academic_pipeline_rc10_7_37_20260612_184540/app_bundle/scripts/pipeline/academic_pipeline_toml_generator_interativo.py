#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Gerador interativo completo de TOML para academic_pipeline rc10.7.36.
...
def wizard_summary(data: dict[str, Any]) -> str:
    ...
    rows: list[tuple[str, list[tuple[str, Any]]]] = [
        ...
        ("Tema, recorte e objetivo", [
            ("tema", data.get("tema")),
            ("recorte", data.get("recorte")),
            ("objetivo", data.get("objetivo")),
            ("palavras-chave", data.get("palavras_chave")),
...
def choose_preset() -> Preset:
    print("\nGerador interativo de TOML — academic_pipeline rc10.7.36")
    print("\nPerfis disponíveis:\n")
...
def generate_interactive(non_interactive_profile: str | None = None, project_name: str | None = None, no_clear: bool = False) -> Path:
    ...
    stages: list[tuple[str, Any]] = [
        ...
        ("Tema, recorte e objetivo", lambda: collect_research(data)),
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Gerador interativo completo de TOML para academic_pipeline rc10.7.36")
