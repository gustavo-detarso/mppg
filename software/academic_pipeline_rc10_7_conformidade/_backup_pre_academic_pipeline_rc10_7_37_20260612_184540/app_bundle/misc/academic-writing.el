...
(defun gm/academic-configure-latex-export ()
  "Configura a exportação LaTeX para escrita acadêmica.
  ...
  (insert
   (mapconcat
    ...
    (list
     ...
     "#+latex_header: % Bibliografia controlada pelo TOML; não usar #+cite_export no modo LaTeX direto"
     (format "#+latex_header: \addbibresource{%s}" gm/academic-default-bibfile)
