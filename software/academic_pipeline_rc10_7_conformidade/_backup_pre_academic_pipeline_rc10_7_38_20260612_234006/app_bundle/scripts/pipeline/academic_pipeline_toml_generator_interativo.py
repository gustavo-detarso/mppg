#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""Gerador interativo completo de TOML para academic_pipeline rc10.7.37.
...
def choose_preset() -> Preset:
    print("\nGerador interativo de TOML — academic_pipeline rc10.7.37")
    print("\nPerfis disponíveis:\n")
...
def collect_research(data: dict[str, Any]) -> None:
    ...
    if preset.document_type == "atividade":
        ...
        print("Palavras-chave: serão inferidas automaticamente pela IA a partir dos dados da atividade e do corpus.")
        data["idiomas"] = ask_list("Idiomas", ["português"])
...
def main(argv: list[str] | None = None) -> int:
    parser = argparse.ArgumentParser(description="Gerador interativo completo de TOML para academic_pipeline rc10.7.37")
