...
3. Injeta style=abnt nas opções do \usepackage[backend=biber,style=abnt,sorting=nty,giveninits=true]{biblatex}.
4. Corrige casos literais de \usepackage[backend=biber,style=abnt,sorting=nty,giveninits=true]{biblatex} sem opções em fontes Python/TEX/ORG geradas.
