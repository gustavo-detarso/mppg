...
DOCUMENT_PROFILES: list[tuple[str, str]] = [
    ("atividade_local_fgv", "[1] Atividade acadêmica local FGV\nEntrega curta, exercício, resenha ou resposta de aula a partir do corpus local."),
    ("resumo_artigos_local_fgv", "[2] Resumo analítico de artigos FGV\nResumos individuais, comparação, síntese analítica e mapa mental opcional."),
    ("paper_local_fgv", "[3] Paper acadêmico local FGV\nPaper a partir de corpus local, com ORG, PDF, DOCX e relatórios."),
    ("paper_prisma_fgv", "[4] Paper + relatório PRISMA FGV\nPaper e pacote de pesquisa/triagem PRISMA."),
    ("dissertacao_local_fgv", "[5] Dissertação local FGV\nDocumento longo com orientador, área, linha e elementos pré-textuais."),
    ("dissertacao_prisma_fgv", "[6] Dissertação + relatório PRISMA FGV\nDissertação com trilha de pesquisa auditável."),
    ("relatorio_prisma_fgv", "[7] Relatório PRISMA autônomo FGV\nSomente documentação e resultados da pesquisa/triagem."),
    ("somente_renderizar_fgv", "[8] Renderizar document.json existente FGV\nRecria ORG/PDF/DOCX sem uma nova chamada à IA."),
]
