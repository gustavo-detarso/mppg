...
- --tui para central operacional guiada de atividades acadêmicas.
"""
...
def main() -> int:
    ...
    parser.add_argument("--tui", action="store_true", help="Abre a Central Operacional de Atividades em terminal")
